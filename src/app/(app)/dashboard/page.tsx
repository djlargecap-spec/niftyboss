    ...
    <div className="p-4 md:p-6 space-y-6 max-w-2xl lg:max-w-5xl">
      ...
      <div>
        <div className="flex items-center gap-2.5 mb-2">
          <Image src="/icons/icon-192.png" alt="CricBoss" width={28} height={28} />
          <span className="text-xs text-muted-foreground font-medium tracking-widest uppercase">CricBoss</span>
        </div>
